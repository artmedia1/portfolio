...
const projects = [
  {
    ...
    technologies: "Next.js, Typescript, PostgreSQL, Prisma, Jest, HTML, CSS"
  },
  {
    ...
    technologies: "React, JavaScript, AWS, Material UI, HTML, CSS"
  },
  {
    ...
    githubLink:
      ...
      technologies: "Javascript, Node.js, ExpressJS, PostgreSQL, Bcryptjs, Passport.js "
  },
  {
    ...
    technologies: "ExpressJS, NodeJS, Javascript, Axios, Bootstrap, AWS, HTML, CSS"
  },
  {
    ...
    technologies: "Java, Java Discord API, Various APIs"
  },
  {
    ...
    githubLink:
      ...
      technologies: "PostgreSQL, ExpressJS, NodeJS, Javascript, Axios, HTML, CSS, EJS "
  },
  {
    imageSrc: "/assets/not-available.png",
    projectName: "Pollen Classification Neural Network",
    projectDescription:
      "Ah, the Engineering Capstone Project – my first large project working with a team. We dove headfirst into the world of neural networks, developing a model that could classify different types of pollen. Think of it like a smart system sorting through thousands of data features. Python was our best friend throughout, with Tensorflow and Keras helping bring our neural network to life. We used Matplotlib and Seaborn to create these cool visualizations that made our data visually interesting. It was a learning curve. One small hiccup though – we were pretty green when it came to version control. So some of the training data wasn't backed up. A tough lesson learned, but hey, that's how you grow, right?",
    githubLink: "https://github.com/artmedia1/pollen-classification",
    technologies: "Python, Pandas, NumPy, Matplotlib, Tensorflow, Keras"
  },
  {
